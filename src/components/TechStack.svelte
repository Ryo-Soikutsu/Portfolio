<script lang="ts">
  ...
  <section class="tech-stack-section" style="--accent:{accent};">
    ...
    <p class="sub-info">
      The following tools are the ones I'm most familiar with, and I've linked the original resource for each tool.
    </p>
        ...
        {#each config.techStack[stackName] as ts}
          <div class="stack-row">
            <div class="stack-label">
              {#if ts.tool}
              <LangBadge language={ts.tool} size={20} />
              {:else}
