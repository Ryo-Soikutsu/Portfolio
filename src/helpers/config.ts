...
const config: SiteConfig = {
  ...
  projectComplimentaryData: [
    ...
    {
      name: "Northland-Blog",
      description: "A central blog to share CTF writeups and challenge creation writeups. Also includes tutorials and documentations for custom tools (e.g. TriviaServer) "
        + "and behind-the-scenes for challenge creation. You can visit the GitBook site at <a href='https://blog.northland.dev'>blog.northland.dev</a>.",
      featured: true,
      thumbnail: '/content/img/blog-live.png'
    }
  ],
